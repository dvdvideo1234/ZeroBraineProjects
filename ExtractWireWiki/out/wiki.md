...
a tracer sensor instance you can take a [look at the example](https://github.com/dvdvideo1234/ControlSystemsE2/blob/master/data/Expression2/e2_code_test_ftracer.txt).

### Can you show me the methods of the class?
The description of the API is provided in the table below.

|ˑˑˑˑˑˑˑˑInstance.creatorˑˑˑˑˑˑˑˑ|ˑOutˑ|ˑDescriptionˑ|
|--------------------------------|-----|-------------|
...
|![image][ref-xft]:`rayNudge`(![image][ref-xxx])|![image][ref-xft]|Nudges the flash trace ray with its own direction and magniture|
