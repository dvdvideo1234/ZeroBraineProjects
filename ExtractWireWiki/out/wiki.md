...
|![image][ref-xft]:`getDisplayFlags`(![image][ref-xxx])|![image][ref-n]|Returns the flash trace [`trace-result`](https://wiki.garrysmod.com/page/Structures/TraceResult) `DispFlags` [`DISPSURF`](https://wiki.facepunch.com/gmod/Enums/DISPSURF) [`bitmask`](https://en.wikipedia.org/wiki/Mask_(computing))|
...
|![image][ref-xft]:`getHitContents`(![image][ref-xxx])|![image][ref-n]|Returns the flash trace [`trace-result`](https://wiki.garrysmod.com/page/Structures/TraceResult) hit surface `Contents` [`CONTENTS`](https://wiki.facepunch.com/gmod/Enums/CONTENTS) [`bitmask`](https://en.wikipedia.org/wiki/Mask_(computing))|
...
|![image][ref-xft]:`getSurfaceFlags`(![image][ref-xxx])|![image][ref-n]|Returns the flash trace [`trace-result`](https://wiki.garrysmod.com/page/Structures/TraceResult) `SurfaceFlags` [`SURF`](https://wiki.facepunch.com/gmod/Enums/SURF) [`bitmask`](https://en.wikipedia.org/wiki/Mask_(computing))|
...
|![image][ref-xft]:`setDir`(![image][ref-n],![image][ref-n],![image][ref-n])|![image][ref-xft]|Updates the flash trace direction using three numbers|
|![image][ref-xft]:`setDir`(![image][ref-r])|![image][ref-xft]|Updates the flash trace direction using an array|
|![image][ref-xft]:`setDir`(![image][ref-v])|![image][ref-xft]|Updates the flash trace direction using a vector|
...
|![image][ref-xft]:`setPos`(![image][ref-n],![image][ref-n],![image][ref-n])|![image][ref-xft]|Updates the flash trace origin position using three numbers|
|![image][ref-xft]:`setPos`(![image][ref-r])|![image][ref-xft]|Updates the flash trace origin position using an array|
|![image][ref-xft]:`setPos`(![image][ref-v])|![image][ref-xft]|Updates the flash trace origin position using a vector|
