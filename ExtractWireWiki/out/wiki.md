...
|![image][ref-e]:`laserGetDataFresnelCount`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] fresnel recursion count|
|![image][ref-e]:`laserGetDataGravitySize`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] black hole step configuration delta|
|![image][ref-e]:`laserGetDataGravityStep`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] black hole step configuration used|
|![image][ref-e]:`laserGetDataIsDisperse`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] dispersion enable flag|
|![image][ref-e]:`laserGetDataIsFresnel`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] fresnel enable flag|
|![image][ref-e]:`laserGetDataIsNoOver`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] no override material flag|
...
|![image][ref-e]:`laserGetDataLengthBeam`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] source [`beam`][ref-5-beam] length|
|![image][ref-e]:`laserGetDataLengthOrig`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] source [`beam`][ref-5-beam] length|
...
|![image][ref-e]:`laserGetDataWaveLength`(![image][ref-n])|![image][ref-n]|Returns the [`laser`][ref-3-laser] [`beam`][ref-5-beam] wavelength|
...
|![image][ref-e]:`laserGetTraceContents`(![image][ref-n])|![image][ref-n]|Returns the [`last trace`][ref-1-last trace] hit [`surface contents enums`][ref-17-surface contents enums]|
...
|![image][ref-e]:`laserGetTraceMatType`(![image][ref-n])|![image][ref-n]|Returns the [`last trace`][ref-1-last trace] [`material type enums`][ref-14-material type enums]|
...
|![image][ref-e]:`laserGetTraceSurfaceFlags`(![image][ref-n])|![image][ref-n]|Returns the [`last trace`][ref-1-last trace] hit [`surface flags enums`][ref-18-surface flags enums]|
...
|![image][ref-e]:`laserGetBeamIgnite`()|![image][ref-n]|Returns the [`laser`][ref-3-laser] source [`beam`][ref-5-beam] ignite|
...
|![image][ref-e]:`laserGetReflectRatio`()|![image][ref-n]|Returns the [`laser`][ref-3-laser] source [`reflection`][ref-15-reflection] ratio flag|
...
|![image][ref-e]:`laserGetReportSize`()|![image][ref-n]|Returns the [`laser`][ref-3-laser] unit hit reports count|
...
|`laserGetDissolveID`(![image][ref-s])|![image][ref-n]|Returns the [`dissolve`][ref-12-dissolve] `ID` for the corresponding [`dissolve`][ref-12-dissolve] type|
...
|`laserGetRefractAngleDeg`(![image][ref-n],![image][ref-n])|![image][ref-n]|Returns the interface critical angle between two media in degrees|
|`laserGetRefractAngleRad`(![image][ref-n],![image][ref-n])|![image][ref-n]|Returns the interface critical angle between two media in radians|
|`laserGetRefractAngleRatio`(![image][ref-n],![image][ref-n])|![image][ref-n]|Returns the interface critical angle relative index between two media|
...
|`laserGetRefractCosine`()|![image][ref-n]|Returns the cosine of the angle between the [`incident`][ref-8-incident] and [`normal`][ref-9-normal] vectors|
|`laserGetRefractDataContent`(![image][ref-s])|![image][ref-n]|Returns the [`refract`][ref-6-refract] loop [`surface content enum`][ref-19-surface content enum] database entry when available|
...
|`laserGetRefractIsNext`()|![image][ref-n]|Returns the flag indicating [`beam`][ref-5-beam] exits the [`medium`][ref-10-medium] after being refracted|
|`laserGetRefractIsSame`()|![image][ref-n]|Returns the flag indicating same [`refraction`][ref-13-refraction] indices arguments are present|
...
[ref-14-material type enums]: https://wiki.facepunch.com/gmod/Enums/MAT
[ref-15-reflection]: https://en.wikipedia.org/wiki/Reflection_(physics)
[ref-16-hit group enums]: https://wiki.facepunch.com/gmod/Enums/HITGROUP
[ref-17-surface contents enums]: https://wiki.facepunch.com/gmod/Enums/CONTENTS
[ref-18-surface flags enums]: https://wiki.facepunch.com/gmod/Enums/SURF
[ref-19-surface content enum]: https://wiki.facepunch.com/gmod/Enums/CONTENTS
