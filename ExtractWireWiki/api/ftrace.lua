local API = {
  ...
  FLAG = {
    ...
    caps = true,  -- (TRUE) Replace tokens by using case insensitive matching
  ...
  REPLACE = {
    ...
    ["origins"]         = "https://en.wikipedia.org/wiki/Origin_(mathematics)",
    ["string"]          = "https://en.wikipedia.org/wiki/String_(computer_science)",
    ["strings"]         = "https://en.wikipedia.org/wiki/String_(computer_science)",
    ["ray"]             = "https://en.wikipedia.org/wiki/Line_(geometry)#Ray",
    ["rays"]            = "https://en.wikipedia.org/wiki/Line_(geometry)#Ray",
    ...
    ["trace struct"]    = "https://wiki.facepunch.com/gmod/Structures/Trace",
    ...
    ["players"]         = "https://wiki.facepunch.com/gmod/Player",
