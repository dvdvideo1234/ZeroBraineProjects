...
DSC["tuneProcIAE(xsc:nnn)"]   = fTuneM:format(tActon[9], "(IAE) Integral absolute error")
DSC["tuneProcISE(xsc:nnn)"]   = fTuneM:format(tActon[9], "(ISE) Integral square error")
DSC["tuneProcITAE(xsc:nnn)"]  = fTuneM:format(tActon[9], "(ITAE) Integral of time-weighted absolute error")
