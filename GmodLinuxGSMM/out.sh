...
mod_info_test=( MOD "test" "Test" "https://github.com/dvdvideo1234/test/archive/master.zip" "test-master.zip" "0" "LowercaseOn" "${systemdir}/addons" "OVERWRITE" "ENGINES" "Garry's Mod;" "NOTGAMES" "https://github.com/dvdvideo1234/test" "test1" )
