...
function COLOR:SetUnpacked( r, g, b, a )
	...
	if ( r ~= nil and not isnumber( r ) ) then error( "Bad argument #1 to 'SetUnpacked' (number expected, got " .. type( r ) .. ")", 2 ) end
	if ( g ~= nil and not isnumber( g ) ) then error( "Bad argument #2 to 'SetUnpacked' (number expected, got " .. type( g ) .. ")", 2 ) end
	if ( b ~= nil and not isnumber( b ) ) then error( "Bad argument #3 to 'SetUnpacked' (number expected, got " .. type( b ) .. ")", 2 ) end
	if ( a ~= nil and not isnumber( a ) ) then error( "Bad argument #4 to 'SetUnpacked' (number expected, got " .. type( a ) .. ")", 2 ) end
